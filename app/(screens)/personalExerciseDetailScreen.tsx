...
//   console.log("exercise-ID-PERSONAL-DETAILS", exerciseId);
...
//                 Equipment
//                 <Text style={styles.detailText}> {exercise.equipmentId}</Text>
//               </ThemedText>
//               <ThemedText type="defaultSemiBold">
//                 Primary Muscles:
//                 <Text style={styles.detailText}>
//                   {exercise.primaryMusclesGroupId}{" "}
//                 </Text>
//               </ThemedText>
//               <ThemedText type="defaultSemiBold">
//                 Secondary Muscles:
//                 <Text style={styles.detailText}>
//                   {exercise.secondaryMusclesGroupId || "None"}
//                 </Text>
//               </ThemedText>
//               <ThemedText type="defaultSemiBold">
//                 Exercise Type:
//                 <Text style={styles.detailText}>{exercise.exerciseTypeId}</Text>
//               </ThemedText>
//             </View>
//           </>
//         ) : (
