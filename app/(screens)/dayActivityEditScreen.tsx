...
//   // Handle text input focus (for editing)
//   const handleTextPress = (workoutId, setIndex, field, currentValue) => {
//     setEditingField({ workoutId, setIndex, field });
//     setEditValue(currentValue); // Set the current value to the text input
//   };
...
//     const { workoutId, setIndex, field } = editingField;
//     handleSetChange(workoutId, setIndex, field, editValue);
//     setEditingField({ workoutId: null, setIndex: null, field: null }); // Exit edit mode
//   };
...
//                   {editingField.workoutId === item.uuid &&
//                   editingField.setIndex === index &&
//                   editingField.field === "kg" ? (
//                     <TextInput
//                       style={styles.input}
//                       value={editValue}
...
//                     <TouchableOpacity
//                       onPress={() =>
//                         handleTextPress(item.uuid, index, "kg", set.kg)
//                       }
//                     >
//                       <Text style={styles.valueText}>{set.kg || "TEst"}</Text>
//                     </TouchableOpacity>
//                   )}
...
//                     <TouchableOpacity
//                       onPress={() =>
//                         handleTextPress(item.uuid, index, "reps", set.reps)
//                       }
//                     >
//                       <Text style={styles.valueText}>{set.reps || "Reps"}</Text>
//                     </TouchableOpacity>
//                   )}
//                 </View>
//               ))}
